        ...
        <li ref={ref} className="my-8 first:mt-0 last:mb-0 w-[60%] mx-auto flex flex-col items-center justify-between">
            ...
            >
                <h3 className="capitalize font-bold text-2xl">{position}&nbsp;
                    <a href={companyLink} target="_blank" className="text-primary dark:text-primary-dark capitalize">@{company} </a></h3>
    ...
    return (
        <div className="mb-64">
            ...
            <div ref={ref} className="w-[75%] mx-auto relative">
                <motion.div style={{ scale: scrollYProgress }} className="absolute left-9 top-0 w-[4px] h-full bg-dark origin-top dark:bg-light" />
