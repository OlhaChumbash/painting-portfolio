...
export const CircularText = ({ className, ...rest }) => (
  <svg xmlns="http://www.w3.org/2000/svg" version="1.0" width="489.000000pt" height="489.000000pt" viewBox="0 0 489.000000 489.000000" className={`w-full h-auto ${className}`} preserveAspectRatio="xMidYMid meet">

    <g transform="translate(0.000000,489.000000) scale(0.100000,-0.100000)" fill="#000000" stroke="none">
